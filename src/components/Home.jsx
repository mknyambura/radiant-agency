...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className='flex flex-row justify-between gap-8 px-20 py-12 mt-16 mb-16'>
            <Swiper
                freeMode={true}
                grabCursor={true}
                modules={FreeMode}
                slidesPerView={1}
                spaceBetween={50}
                className='w-1/2  mySwiper flex flex-row  justify-start overflow-x-scroll overflow-y-hidden'
            >
                <SwiperSlide className='flex flex-col items-center justify-center'>
                    <div className='flex flex-col items-center justify-center'>
                        <img src={mid1} alt="" width={400}/>
                    </div>
                </SwiperSlide>
                <SwiperSlide className='flex flex-col items-center justify-center'>
            ...
            <div className='flex flex-col justify-evenly w-1/2 px-12 py-12 gap-8'>
                <h1 className='font-bold text-5xl'>Top Class Web Development Agency</h1>
                ...
                <button className='w-[40%] mt-16 text-white bg-[#FF723A] px-4 py-2 rounded-lg'>Explore More</button>
            </div>
        </div>
        <div className='flex flex-col items-center gap-12 mt-16 mb-16'>
        ...
        <div className='flex flex-row px-20 py-12 mt-16 mb-16 justify-between'>
            ...
            <div className='w-[60%] mb-16 flex flex-col justify-between relative'>
                <div className=''>
                    <img src={formImage} alt="" />
                </div>
                <form className='absolute top-[-14.4%] left-[35%] bg-[#2F2E41] px-3 py-3 rounded-lg'>
                    ...
                    <button className='w-1/2 bg-[#FF723A] px-4 py-2 rounded-md'>Send Message</button>
                </form>
            </div>
        </div>
        <div className='flex flex-col gap-12 mt-16 '>
            <div className='flex flex-col items-center justify-center'>
                <h1 className='font-bold text-5xl'>Get Started with 4 Easy Steps</h1>
            </div>
            <div className='flex flex-row mt-16 mb-16 px-20 justify-evenly gap-2'>
                {data.steps.map((step) => (
                    <div
                        key={step.id}
        ...
        <div className=' flex flex-col gap-8 px-20 py-12'>
            ...
            <div className=' flex flex-row justify-between gap-12 px-6 py-6'>
